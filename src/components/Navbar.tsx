...
const WHATSAPP_URL = "https://wa.me/8613800000000";
...
export default function Navbar({
  ...
  const NAV_LINKS = [
    { href: "#home", label: nav.links[0] },
    { href: "#products", label: nav.links[1] },
    { href: "#technology", label: nav.links[2] },
    { href: "#about", label: nav.links[3] },
    { href: "#contact", label: nav.links[4] },
  ];
